...
function HomePage(){
    ...
    function defaultFilter(task){ alert(1); return true; }
    function activeTasksFilter(task){  alert(2); return  task && !task.isDone; }
    function completedTasksFilter(task){  alert(3); return task && task.isDone; };
