...
function TaskComponent({task,removeTask}){
        ...
        <Form.Group className="mb-3" >
                <Row>
           <Form.Check type="checkbox" checked={task.isDone} onChange={()=>task.setIsDone(!task.isDone)}/> 
           <input type="checkbox" checked={task.isDone} onChange={() => task.setIsDone(!task.isDone)}/>
